...
export function createCardsList () {
    const fetchCards = fetch(`${configApi.httpsApi}/cards`, {
        headers: {
            authorization: configApi.authorizationApi
        }
    })

    const fetchUserData = fetch(`${configApi.httpsApi}/users`, {
        headers: {
            authorization: configApi.authorizationApi
        }
    })
    return Promise.all([fetchCards, fetchUserData])
}
...
export function checkLikeApiCard () {
    return fetch(`${configApi.httpsApi}/cards`, {
        headers: {
            authorization: configApi.authorizationApi,
        },
...
export function remuveLikeApiCard (cardId) {
    return fetch(`${configApi.httpsApi}/cards/likes/${cardId}`, {
        method: 'DELETE',
        headers: {
            authorization: configApi.authorizationApi,
